...
const projects = [
  {
    ...
    stats: { metric1: '40%', metric2: 'Lower Churn' },
  },
  {
    title: 'FashionHub',
    category: 'E-commerce',
    ...
    stats: { metric1: '99.99%', metric2: 'Uptime' },
  },
  {
    title: 'PayFast Ro',
    category: 'FinTech',
    description:
      'Refactorizare completă React & Node.js, microservicii.',
    image:
    ...
    stats: { metric1: '2x', metric2: 'Viteză Dev' },
  },
]
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <h2 className={styles.title}>
            Proiecte de care suntem{' '}
            <span className={styles.highlight}>mândri</span>
          </h2>
          <p className={styles.subtitle}>
            Fiecare proiect este o poveste de succes. Vezi câteva dintre
            realizările noastre recente.
          </p>
        </div>
